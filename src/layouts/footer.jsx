export const Footer = () => {
  return (
    <footer className="px-10 md:px-20 py-10 md:pt-36 bg-zinc-800 text-white" id="about">
      <div className="px-4 md:px-20 flex flex-col md:flex-row w-full justify-between">
        <div>
